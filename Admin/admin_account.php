              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-add">
                    <i class="fa fa-plus"></i>&nbsp ADD ADMIN
                  </button>
                </div>
            ...
            <div class="box-body">
              <form role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact Number" name="contact_number" required>
                </div>
              ...
              <div class="modal-header">
                ...
                <div class="modal-body">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Contact Number</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact Number">
                    </div>
