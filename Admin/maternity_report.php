...
class MyPdf extends FPDF{
	...
	function HeaderTable(){
		...
		$this->Cell(110,10,'Progress Notes',1,0,'C');

		$this->Cell(90,10,'Date Taken',1,0,'C');
		$this->Ln();
...
function Userdetails(){
	...
	function Title(){
		...
		$this->Cell(276,10," Recovery Progress Tracking",0,0,'C');
		$this->Ln();
	...
	function Table(){
		...
		while ($row = mysqli_fetch_assoc($result)) {
			...
			$this->Cell(110,10,$progress_notes,1,0,'C');
			$this->Cell(90,10,$date_taken,1,0,'C');
			$this->Ln();
