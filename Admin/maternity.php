        ...
        <div class="content-wrapper">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#modal-addprogress">
                <i class="fa fa-plus"></i>&nbsp ADD PROGRESS
              </button>
            </div>
