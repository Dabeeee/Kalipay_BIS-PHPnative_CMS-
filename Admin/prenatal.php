      ...
      <div class="content-wrapper">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title">TESTS COMPLETED</h3>
            <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#modal-addtest">
              <i class="fa fa-plus"></i>&nbsp DONE TESTS
            </button>
          </div>
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title">CHECKUP MEETINGS</h3>
            <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#modal-addmeeting">
              <i class="fa fa-plus"></i>&nbsp DONE CHECKUPS
            </button>
          </div>
